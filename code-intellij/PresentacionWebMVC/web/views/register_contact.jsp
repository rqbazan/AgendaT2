...
<body>
    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12 col-centered">
                    <frm:form method="post" action="registercontact">
                        <div class="form-group ">
                            <frm:input class="form-control" id="name" path="name" placeholder="Nombres" type="text" required="required"/>
                        </div>
                        <div class="form-group ">
                            <frm:input class="form-control" id="lastName" path="lastName" placeholder="Apellidos" type="text" required="required"/>
                        </div>
                        <div class="form-group ">
                            <frm:input class="form-control" id="cellphoneNumber" path="cellphoneNumber" placeholder="Celular" type="text" required="required"/>
                        </div>
                        <div class="form-group ">
                            <frm:input class="form-control" id="email" path="email" placeholder="Correo-e" type="text" required="required"/>
                        </div>
                        <div class="form-group ">
                            <frm:input class="form-control" id="dni" path="dni" placeholder="DNI" type="text" required="required"/>
                        </div>
                        <div class="form-group ">
                            ...
                            <div class="">
                                <div class="radio">
                                    <label class="radio">
                                        <frm:radiobutton path="sex" value="M"/>
                                        M
                                    </label>
                                </div>
                                <div class="radio">
                                    <label class="radio">
                                        <frm:radiobutton path="sex"  value="F"/>
                                        F
                                    </label>
                                </div>
                            </div>
